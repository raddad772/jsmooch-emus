...
static void setup_events_view(struct NES* this, struct debugger_interface *dbgr)
{
    ...
    DEBUG_REGISTER_EVENT("Write $2000 (PPUCTRL)", 0xFFD020, DBG_NES_CATEGORY_PPU, DBG_NES_EVENT_W2000);
    DEBUG_REGISTER_EVENT("Write $2006 (PPUADDR)", 0xFF0080, DBG_NES_CATEGORY_PPU, DBG_NES_EVENT_W2006);
    DEBUG_REGISTER_EVENT("Write $2007 (PPUDATA)", 0x0080FF, DBG_NES_CATEGORY_PPU, DBG_NES_EVENT_W2007);
