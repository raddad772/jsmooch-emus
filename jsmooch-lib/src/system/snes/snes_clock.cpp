...
void SNES_clock::fill_timing_ntsc()
{
    ...
    apu.sample.stride = (long double)timing.second.master_cycles / 32000.0;
    apu.cycle.stride = (long double)timing.second.master_cycles / 1024000.0;
    apu.env.stride = (long double)timing.second.master_cycles / 32000.0;
    //apu.sample.pitch_ratio =  (long double)timing.second.master_cycles / 131072000.0;
    apu.sample.pitch_ratio =  (long double)timing.second.master_cycles / 131072.0;
