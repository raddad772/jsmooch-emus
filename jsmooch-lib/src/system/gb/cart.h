...
void GB_cart_init(struct GB_cart* cart, enum GB_variants variant, GB_clock* clock, GB_bus* bus);
void GB_cart_delete(struct GB_cart*);
void GB_cart_load_ROM_from_RAM(struct GB_cart*, void* ibuf, u64 size, physical_io_device *pio);
