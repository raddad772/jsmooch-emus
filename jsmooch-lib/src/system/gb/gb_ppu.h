...
void GB_PPU_init(GB_PPU*, enum GB_variants variant, GB_clock* clock, GB_bus* bus);
void GB_PPU_run_cycles(GB_PPU*, u32 howmany);
void GB_PPU_quick_boot(GB_PPU*);
void GB_PPU_reset(GB_PPU*);
