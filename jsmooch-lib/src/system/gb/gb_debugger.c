...
static void setup_events_view(struct GB* this, struct debugger_interface *dbgr)
{
    ...
    DEBUG_REGISTER_EVENT("STAT write", 0x4580FF, DBG_GB_CATEGORY_PPU, DBG_GB_EVENT_STAT_WRITE);
    DEBUG_REGISTER_EVENT("LCDC write", 0x2080FF, DBG_GB_CATEGORY_PPU, DBG_GB_EVENT_LCDC_WRITE);
    DEBUG_REGISTER_EVENT("BGP write", 0x208020, DBG_GB_CATEGORY_PPU, DBG_GB_EVENT_BGP_WRITE);
