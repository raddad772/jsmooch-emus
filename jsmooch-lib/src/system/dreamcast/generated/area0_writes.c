        ...
        case 0x005F6900: { this->io.SB_ISTNRM.u ^= this->io.SB_ISTNRM.u & val & 0x3FFFFF; return; }
        case 0x005F6908: { this->io.SB_ISTERR.u ^= this->io.SB_ISTERR.u & val & 0x9FFFFFFF; return; }
        case 0x005F6910: { this->io.SB_IML2NRM = val; holly_recalc_interrupts(this); return; }
        case 0x005F6914: { this->io.SB_IML2EXT.u = val & 0x0000000F; holly_recalc_interrupts(this); return; }
        case 0x005F6918: { this->io.SB_IML2ERR.u = val & 0x9FFFFFFF; return; }
        case 0x005F6920: { this->io.SB_IML4NRM = val; holly_recalc_interrupts(this); return; }
        case 0x005F6924: { this->io.SB_IML4EXT.u = val & 0x0000000F; holly_recalc_interrupts(this); return; }
        case 0x005F6928: { this->io.SB_IML4ERR.u = val & 0x9FFFFFFF; return; }
        case 0x005F6930: { this->io.SB_IML6NRM = val; holly_recalc_interrupts(this); return; }
        case 0x005F6934: { this->io.SB_IML6EXT.u = val & 0x0000000F; holly_recalc_interrupts(this); return; }
