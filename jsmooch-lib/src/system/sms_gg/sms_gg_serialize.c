...
static void serialize_console(struct SMSGG *this, serialized_state *state)
{
    // Serialize parts now
...
static void serialize_debug(struct SMSGG *this, serialized_state *state)
{
...
static void serialize_clock(struct SMSGG *this, serialized_state *state)
{
...
static void serialize_z80(struct SMSGG *this, serialized_state *state)
{
    serialized_state_new_section(state, "z80", SMSGGSS_z80, 1);
    Z80_serialize(&this->cpu, state);
}

static void serialize_mapper(struct SMSGG *this, serialized_state *state)
{
...
static void serialize_vdp(struct SMSGG *this, serialized_state *state)
{
...
static void serialize_sn76489(struct SMSGG *this, serialized_state *state)
{
...
void SMSGGJ_save_state(struct jsm_system* jsm, serialized_state *state)
{
...
static void deserialize_console(struct SMSGG* this, serialized_state *state)
{
...
static void deserialize_debug(struct SMSGG* this, serialized_state *state)
{
...
static void deserialize_vdp(struct SMSGG* this, serialized_state *state)
{
...
static void deserialize_sn76489(struct SMSGG* this, serialized_state *state)
{
    SN76489_deserialize(&this->sn76489, state);
}

static void deserialize_z80(struct SMSGG* this, serialized_state *state)
{
    Z80_deserialize(&this->cpu, state);
}

static void deserialize_clock(struct SMSGG* this, serialized_state *state)
{
...
static void deserialize_mapper(struct SMSGG* this, serialized_state *state)
{
...
void SMSGGJ_load_state(struct jsm_system *jsm, serialized_state *state, deserialize_ret *ret)
{
    state->iter.offset = 0;
