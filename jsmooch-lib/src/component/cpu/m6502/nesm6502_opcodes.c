...
static void nesM6502_ins_AB_LAX(struct M6502_regs *regs, struct M6502_pins *pins)
{
    switch(regs->TCU) {
        case 1: {
            pins->Addr = regs->PC;
...
static void nesM6502_ins_CB_AXS(struct M6502_regs *regs, struct M6502_pins *pins)
{
    switch(regs->TCU) {
        case 1: {
            pins->Addr = regs->PC;
