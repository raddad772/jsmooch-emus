...
#define SM83_S_RESET 0x101
#define SM83_S_IRQ 0x100
#define SM83_HALT 0x76
#define SM83_S_DECODE 0x102
#define SM83_MAX_OPCODE 0x101


struct SM83_regs;
struct SM83_pins;

typedef void (*SM83_ins_func)(SM83_regs*, SM83_pins*);
...
struct SM83_opcode_function {
    u8 opcode;
    enum SM83_MN ins;
    SM83_ins_func exec_func;
};
