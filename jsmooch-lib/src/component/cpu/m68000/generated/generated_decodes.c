    ...
    for (u32 d = 0; d < 8; d++) {
        for (u32 m = 0; m < 8; m++) {
            for (u32 r = 0; r < 8; r++) {
                ...
                op1 = mk_ea(M68k_AM_data_register_direct, d);
                op2 = mk_ea(m, r);
                if (m == 0) bind_opcode("0000 ...1 01.. ....", 4, &M68k_ins_BCHG, &M68k_disasm_BCHG, (d << 9) | (m << 3) | r, &op1, &op2, 0, M68k_OM_r_ea);
                else        bind_opcode("0000 ...1 01.. ....", 1, &M68k_ins_BCHG, &M68k_disasm_BCHG, (d << 9) | (m << 3) | r, &op1, &op2, 0, M68k_OM_r_ea);
            }
        }
    }
    ...
    for (u32 m = 0; m < 8; m++) {
        for (u32 r = 0; r < 8; r++) {
            if ((m == 1) || ((m == 7) && (r >= 2))) continue;
            op1 = mk_ea(m, r);
            if (m == 0) bind_opcode("0000 1000 01.. ....", 4, &M68k_ins_BCHG, &M68k_disasm_BCHG, (m << 3) | r, &op1, NULL, 1, M68k_OM_ea);
            else        bind_opcode("0000 1000 01.. ....", 1, &M68k_ins_BCHG, &M68k_disasm_BCHG, (m << 3) | r, &op1, NULL, 1, M68k_OM_ea);
        }
    }
    ...
    for (u32 d = 0; d < 8; d++) {
        for (u32 m = 0; m < 8; m++) {
            for (u32 r = 0; r < 8; r++) {
                ...
                op1 = mk_ea(M68k_AM_data_register_direct, d);
                op2 = mk_ea(m, r);
                if (m == 0) bind_opcode("0000 ...1 00.. ....", 4, &M68k_ins_BTST, &M68k_disasm_BTST, (d << 9) | (m << 3) | r, &op1, &op2, 0, M68k_OM_r_ea);
                else        bind_opcode("0000 ...1 00.. ....", 1, &M68k_ins_BTST, &M68k_disasm_BTST, (d << 9) | (m << 3) | r, &op1, &op2, 0, M68k_OM_r_ea);
            }
        }
    }
    ...
    for (u32 m = 0; m < 8; m++) {
        for (u32 r = 0; r < 8; r++) {
            ...
            op1 = mk_ea(m, r);
            if (m == 0) bind_opcode("0000 1000 00.. ....", 4, &M68k_ins_BTST, &M68k_disasm_BTST, (m << 3) | r, &op1, NULL, 1, M68k_OM_ea);
            else        bind_opcode("0000 1000 00.. ....", 1, &M68k_ins_BTST, &M68k_disasm_BTST, (m << 3) | r, &op1, NULL, 1, M68k_OM_ea);
        }
    }
    ...
    for (u32 d = 0; d < 8; d++) {
        for (u32 m = 0; m < 8; m++) {
            for (u32 r = 0; r < 8; r++) {
                ...
                op1 = mk_ea(M68k_AM_data_register_direct, d);
                op2 = mk_ea(m, r);
                bind_opcode("0100 ...1 10.. ....", 4, &M68k_ins_CHK, &M68k_disasm_CHK, (d << 9) | (m << 3) | r, &op1, &op2, 0, M68k_OM_r_ea);
            }
        }
    }
    ...
    for (u32 i = 0; i < 8; i++) {
        for (u32 d = 0; d < 8; d++) {
            op1 = mk_ea(M68k_AM_immediate, i ? i : 8);
            op2 = mk_ea(M68k_AM_data_register_direct, d);
            bind_opcode("1110 ...1 0000 1...", 1, &M68k_ins_LSL, &M68k_disasm_LSL, (i << 9) | d, &op1, &op2, 0, M68k_OM_qimm_r);
            bind_opcode("1110 ...1 0100 1...", 2, &M68k_ins_LSL, &M68k_disasm_LSL, (i << 9) | d, &op1, &op2, 0, M68k_OM_qimm_r);
            bind_opcode("1110 ...1 1000 1...", 4, &M68k_ins_LSL, &M68k_disasm_LSL, (i << 9) | d, &op1, &op2, 0, M68k_OM_qimm_r);
        }
    }
    ...
    for (u32 s = 0; s < 8; s++) {
        for (u32 d = 0; d < 8; d++) {
            op1 = mk_ea(M68k_AM_data_register_direct, s);
            op2 = mk_ea(M68k_AM_data_register_direct, d);
            bind_opcode("1110 ...1 0010 1...", 1, &M68k_ins_LSL, &M68k_disasm_LSL, (s << 9) | d, &op1, &op2, 1, M68k_OM_r_r);
            bind_opcode("1110 ...1 0110 1...", 2, &M68k_ins_LSL, &M68k_disasm_LSL, (s << 9) | d, &op1, &op2, 1, M68k_OM_r_r);
            bind_opcode("1110 ...1 1010 1...", 4, &M68k_ins_LSL, &M68k_disasm_LSL, (s << 9) | d, &op1, &op2, 1, M68k_OM_r_r);
        }
    }
    ...
    for (u32 m = 0; m < 8; m++) {
        for (u32 r = 0; r < 8; r++) {
            if ((m <= 1) || ((m == 7) && (r >= 2))) continue;
            op1 = mk_ea(m, r);
            bind_opcode("1110 0011 11.. ....", 4, &M68k_ins_LSL, &M68k_disasm_LSL, (m << 3) | r, &op1, NULL, 2, M68k_OM_ea);
        }
    }
    ...
    for (u32 i = 0; i < 8; i++) {
        for (u32 d = 0; d < 8; d++) {
            op1 = mk_ea(M68k_AM_immediate, i ? i : 8);
            op2 = mk_ea(M68k_AM_data_register_direct, d);
            bind_opcode("1110 ...0 0000 1...", 1, &M68k_ins_LSR, &M68k_disasm_LSR, (i << 9) | d, &op1, &op2, 0, M68k_OM_qimm_r);
            bind_opcode("1110 ...0 0100 1...", 2, &M68k_ins_LSR, &M68k_disasm_LSR, (i << 9) | d, &op1, &op2, 0, M68k_OM_qimm_r);
            bind_opcode("1110 ...0 1000 1...", 4, &M68k_ins_LSR, &M68k_disasm_LSR, (i << 9) | d, &op1, &op2, 0, M68k_OM_qimm_r);
        }
    }
    ...
    for (u32 s = 0; s < 8; s++) {
        for (u32 d = 0; d < 8; d++) {
            op1 = mk_ea(M68k_AM_data_register_direct, s);
            op2 = mk_ea(M68k_AM_data_register_direct, d);
            bind_opcode("1110 ...0 0010 1...", 1, &M68k_ins_LSR, &M68k_disasm_LSR, (s << 9) | d, &op1, &op2, 1, M68k_OM_r_r);
            bind_opcode("1110 ...0 0110 1...", 2, &M68k_ins_LSR, &M68k_disasm_LSR, (s << 9) | d, &op1, &op2, 1, M68k_OM_r_r);
            bind_opcode("1110 ...0 1010 1...", 4, &M68k_ins_LSR, &M68k_disasm_LSR, (s << 9) | d, &op1, &op2, 1, M68k_OM_r_r);
        }
    }
    ...
    for (u32 m = 0; m < 8; m++) {
        for (u32 r = 0; r < 8; r++) {
            if ((m <= 1) || ((m == 7) && (r >= 2))) continue;
            op1 = mk_ea(m, r);
            bind_opcode("1110 0010 11.. ....", 4, &M68k_ins_LSR, &M68k_disasm_LSR, (m << 3) | r, &op1, NULL, 2, M68k_OM_ea);
        }
    }
    ...
    for (u32 a = 0; a < 8; a++) {
        for (u32 m = 0; m < 8; m++) {
            for (u32 r = 0; r < 8; r++) {
                ...
                op1 = mk_ea(m, r);
                op2 = mk_ea(M68k_AM_address_register_direct, a);
                bind_opcode("0000 ...0 01.. ....", 2, &M68k_ins_MOVEA, &M68k_disasm_MOVEA, (a << 9) | (m << 3) | r, &op1, &op2, 0, M68k_OM_ea_r);
                bind_opcode("0001 ...0 01.. ....", 4, &M68k_ins_MOVEA, &M68k_disasm_MOVEA, (a << 9) | (m << 3) | r, &op1, &op2, 0, M68k_OM_ea_r);
            }
        }
    }
    ...
    for (u32 m = 0; m < 8; m++) {
        for (u32 r = 0; r < 8; r++) {
            if ((m == 1) || ((m == 7) && (r >= 2))) continue;
            op1 = mk_ea(m, r);
            bind_opcode("0100 0000 11.. ....", 4, &M68k_ins_MOVE_FROM_SR, &M68k_disasm_MOVE_FROM_SR, (m << 3) | r, &op1, NULL, 0, M68k_OM_ea);
        }
    }
    ...
    for (u32 m = 0; m < 8; m++) {
        for (u32 r = 0; r < 8; r++) {
            if ((m == 1) || ((m == 7) && (r >= 5))) continue;
            op1 = mk_ea(m, r);
            bind_opcode("0100 0110 11.. ....", 4, &M68k_ins_MOVE_TO_SR, &M68k_disasm_MOVE_TO_SR, (m << 3) | r, &op1, NULL, 0, M68k_OM_ea);
        }
    }
    ...
    for (u32 d = 0; d < 8; d++) {
        for (u32 m = 0; m < 8; m++) {
            for (u32 r = 0; r < 8; r++) {
                ...
                op1 = mk_ea(m, r);
                op2 = mk_ea(M68k_AM_data_register_direct, d);
                bind_opcode("1100 ...1 11.. ....", 4, &M68k_ins_MULS, &M68k_disasm_MULS, (d << 9) | (m << 3) | r, &op1, &op2, 0, M68k_OM_ea_r);
            }
        }
    }
    ...
    for (u32 d = 0; d < 8; d++) {
        for (u32 m = 0; m < 8; m++) {
            for (u32 r = 0; r < 8; r++) {
                ...
                op1 = mk_ea(m, r);
                op2 = mk_ea(M68k_AM_data_register_direct, d);
                bind_opcode("1100 ...0 11.. ....", 4, &M68k_ins_MULU, &M68k_disasm_MULU, (d << 9) | (m << 3) | r, &op1, &op2, 0, M68k_OM_ea_r);
            }
        }
    }
    ...
    for (u32 m = 0; m < 8; m++) {
        for (u32 r = 0; r < 8; r++) {
            if ((m == 1) || ((m == 7) && (r >= 2))) continue;
            op1 = mk_ea(m, r);
            bind_opcode("0100 1000 00.. ....", 4, &M68k_ins_NBCD, &M68k_disasm_NBCD, (m << 3) | r, &op1, NULL, 0, M68k_OM_ea);
        }
    }
    ...
    for (u32 i = 0; i < 8; i++) {
        for (u32 d = 0; d < 8; d++) {
            op1 = mk_ea(M68k_AM_immediate, i ? i : 8);
            op2 = mk_ea(M68k_AM_data_register_direct, d);
            bind_opcode("1110 ...1 0001 0...", 1, &M68k_ins_ROXL, &M68k_disasm_ROXL, (i << 9) | d, &op1, &op2, 0, M68k_OM_qimm_r);
            bind_opcode("1110 ...1 0101 0...", 2, &M68k_ins_ROXL, &M68k_disasm_ROXL, (i << 9) | d, &op1, &op2, 0, M68k_OM_qimm_r);
            bind_opcode("1110 ...1 1001 0...", 4, &M68k_ins_ROXL, &M68k_disasm_ROXL, (i << 9) | d, &op1, &op2, 0, M68k_OM_qimm_r);
        }
    }
    ...
    for (u32 s = 0; s < 8; s++) {
        for (u32 d = 0; d < 8; d++) {
            op1 = mk_ea(M68k_AM_data_register_direct, s);
            op2 = mk_ea(M68k_AM_data_register_direct, d);
            bind_opcode("1110 ...1 0011 0...", 1, &M68k_ins_ROXL, &M68k_disasm_ROXL, (s << 9) | d, &op1, &op2, 1, M68k_OM_r_r);
            bind_opcode("1110 ...1 0111 0...", 2, &M68k_ins_ROXL, &M68k_disasm_ROXL, (s << 9) | d, &op1, &op2, 1, M68k_OM_r_r);
            bind_opcode("1110 ...1 1011 0...", 4, &M68k_ins_ROXL, &M68k_disasm_ROXL, (s << 9) | d, &op1, &op2, 1, M68k_OM_r_r);
        }
    }
    ...
    for (u32 m = 0; m < 8; m++) {
        for (u32 r = 0; r < 8; r++) {
            if ((m <= 1) || ((m == 7) && (r >= 2))) continue;
            op1 = mk_ea(m, r);
            bind_opcode("1110 0101 11.. ....", 4, &M68k_ins_ROXL, &M68k_disasm_ROXL, (m << 3) | r, &op1, NULL, 2, M68k_OM_ea);
        }
    }
    ...
    for (u32 i = 0; i < 8; i++) {
        for (u32 d = 0; d < 8; d++) {
            op1 = mk_ea(M68k_AM_immediate, i ? i : 8);
            op2 = mk_ea(M68k_AM_data_register_direct, d);
            bind_opcode("1110 ...0 0001 0...", 1, &M68k_ins_ROXR, &M68k_disasm_ROXR, (i << 9) | d, &op1, &op2, 0, M68k_OM_qimm_r);
            bind_opcode("1110 ...0 0101 0...", 2, &M68k_ins_ROXR, &M68k_disasm_ROXR, (i << 9) | d, &op1, &op2, 0, M68k_OM_qimm_r);
            bind_opcode("1110 ...0 1001 0...", 4, &M68k_ins_ROXR, &M68k_disasm_ROXR, (i << 9) | d, &op1, &op2, 0, M68k_OM_qimm_r);
        }
    }
    ...
    for (u32 s = 0; s < 8; s++) {
        for (u32 d = 0; d < 8; d++) {
            op1 = mk_ea(M68k_AM_data_register_direct, s);
            op2 = mk_ea(M68k_AM_data_register_direct, d);
            bind_opcode("1110 ...0 0011 0...", 1, &M68k_ins_ROXR, &M68k_disasm_ROXR, (s << 9) | d, &op1, &op2, 1, M68k_OM_r_r);
            bind_opcode("1110 ...0 0111 0...", 2, &M68k_ins_ROXR, &M68k_disasm_ROXR, (s << 9) | d, &op1, &op2, 1, M68k_OM_r_r);
            bind_opcode("1110 ...0 1011 0...", 4, &M68k_ins_ROXR, &M68k_disasm_ROXR, (s << 9) | d, &op1, &op2, 1, M68k_OM_r_r);
        }
    }
    ...
    for (u32 m = 0; m < 8; m++) {
        for (u32 r = 0; r < 8; r++) {
            if ((m <= 1) || ((m == 7) && (r >= 2))) continue;
            op1 = mk_ea(m, r);
            bind_opcode("1110 0100 11.. ....", 4, &M68k_ins_ROXR, &M68k_disasm_ROXR, (m << 3) | r, &op1, NULL, 2, M68k_OM_ea);
        }
    }
    ...
    bind_opcode("0100 1110 0111 0110", 4, &M68k_ins_TRAP, &M68k_disasm_TRAP, 0, NULL, NULL, 0, M68k_OM_none);
