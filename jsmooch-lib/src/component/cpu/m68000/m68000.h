...
void M68k_cycle(M68k*);
void M68k_init(M68k*, u32 megadrive_bug);
void M68k_delete(M68k*);
void M68k_reset(M68k*);
void M68k_setup_tracing(M68k*, jsm_debug_read_trace *strct, u64 *trace_cycle_pointer);
void M68k_unstop(M68k*);
void M68k_set_interrupt_level(M68k*, u32 val);
void M68k_disassemble_entry(M68k*, disassembly_entry* entry);
void M68k_set_SR(M68k*, u32 val, u32 immediate_t);
u32 M68k_get_SR(M68k*);
void M68k_register_iack_handler(M68k*, void *, void (*handler)(void*));
struct serialized_state;
void M68k_serialize(M68k *, serialized_state *state);
void M68k_deserialize(M68k*, serialized_state *state);
