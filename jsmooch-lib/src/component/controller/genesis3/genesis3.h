...
void genesis_controller_3button_init(genesis_controller_3button*);
void genesis_controller_3button_delete(genesis_controller_3button*);
void genesis_controller_3button_latch(genesis_controller_3button*);

void genesis3_setup_pio(physical_io_device *d, u32 num, const char*name, u32 connected);

u8 genesis3_read_data(genesis_controller_3button *);
void genesis3_write_data(genesis_controller_3button *, u8 val);
