...
void genesis_controller_6button_latch(genesis_controller_6button*);

void genesis6_setup_pio(physical_io_device *d, u32 num, const char*name, u32 connected);

u8 genesis6_read_data(genesis_controller_6button *);
void genesis6_write_data(genesis_controller_6button *, u8 val);
