...
def C_func_sig(mo, tbit):
    return 'static void ' + C_func_name(mo, tbit) + '(HUC6280_regs *regs, HUC6280_pins *pins)'
...
def main():
    ...
    with open(outinsfile, 'w') as outfile:
        ...
        outfile.write('\n')
        #outfile.write('static voidHUC6280_ins_NONE(HUC6280_regs *regs, HUC6280_pins *pins)\n')
        #outfile.write('{\n')
